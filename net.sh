...
# Step 3: Create a bridged network (br0)
...
# Step 4: Create veth pairs and attach to the bridge
...
# Step 5: Attach veth pairs to containers
...
# Step 6: Configure IP addresses for containers
...
# Step 7: Configure iptables for one-way communication
